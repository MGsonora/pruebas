...
use Test\MainBundle\Form\ProductoType;
...
class ProductoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MainBundle:Producto')->findAll();
     ...
     * @Method("POST")
     * @Template("MainBundle:Producto:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MainBundle:Producto')->find($id);
     ...
     * @Method("PUT")
     * @Template("MainBundle:Producto:edit.html.twig")
     */
